...
{
    Point result = {0, 0, 1}; // Initialize as point at infinity
    Point addend = P;
...
<img width="431" height="160" alt="image" src="https://github.com/user-attachments/assets/ae812a42-3698-44d9-b685-7bc01b7e0d3f" />
